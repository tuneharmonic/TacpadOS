class_name StratagemInput extends StratagemReceiver
...
onready var audio_stream_player: AudioStreamPlayer = $StratagemPanel/AudioStreamPlayer
...
func _on_back_button_pressed():
	emit_signal("load_scene", "res://Scenes/clock.tscn")
